...
if __name__ == "__main__":
    ...
    pet_path = PathSelection("(Optional) Select the image folder/file you want transform to MIP", False)
    mask_path = PathSelection("(Optional) Select the image folder/file you want transform to MIP",
                              pet_path.is_folder).path
    record_folder = "MIP"
